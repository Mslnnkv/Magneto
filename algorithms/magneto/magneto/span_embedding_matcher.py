...
class SpanEmbeddingMatcher:
    def __init__(self, params):
        ...
        self.target_start_marker = params.get("target_start_marker", "<<TARGET_START>>")
        self.target_end_marker = params.get("target_end_marker", "<<TARGET_END>>")
    ...
    def _build_encoder(self):
        return SpanContextualEncoder(
            ...
            target_start_marker=self.target_start_marker,
    ...
    def _extract_span_embedding(self, encoded_item):
        ...
        with torch.no_grad():
            outputs = transformer(**tokenized_no_offsets)
