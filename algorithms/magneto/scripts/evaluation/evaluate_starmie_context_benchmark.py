...
def main():
    ...
    summary_df.to_csv(BENCHMARK_DIR / "version_6_evaluation_results.csv", index=False)
    errors_df.to_csv(BENCHMARK_DIR / "version_6_evaluation_errors.csv", index=False)
    print("\nSaved to:", (BENCHMARK_DIR / "version_6_evaluation_results.csv").resolve())
