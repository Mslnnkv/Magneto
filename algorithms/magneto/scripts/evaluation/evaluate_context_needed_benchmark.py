...
def main():
    ...
    summary_df.to_csv(BENCHMARK_DIR / "version_3_results.csv", index=False)
    errors_df.to_csv(BENCHMARK_DIR / "version_3_errors.csv", index=False)
    print("\nSaved to:", (BENCHMARK_DIR / "version_3_results.csv").resolve())
