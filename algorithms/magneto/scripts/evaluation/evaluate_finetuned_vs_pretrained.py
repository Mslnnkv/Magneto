...
def main():
    ...
    summary_df.to_csv(BENCHMARK_DIR / "finetuned_vs_pretrained_results.csv", index=False)
    errors_df.to_csv(BENCHMARK_DIR / "finetuned_vs_pretrained_errors.csv", index=False)
